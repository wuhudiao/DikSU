...
pub fn on_post_data_fs() -> Result<()> {
    ...
    // The Web UI is not started here on purpose: this stage runs in a short-lived init
    // child, so anything spawned would die with it. It is started on demand instead
